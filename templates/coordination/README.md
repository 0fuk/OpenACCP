...
3. `runtime-boundary.json`: working directory, product repo path, inferred base branch, source roots, test entrypoints, worktree policy, inference evidence, ambiguity notes, writable/read-only/forbidden paths, side effects, data risk, and `b2DispatchGate`.
